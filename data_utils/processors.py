...
train_file = myconfig.train_file
dev_file = myconfig.dev_file
...
class DataProcessor(ABC):
    ...
    @abstractmethod
    def get_test_examples_poison(self, data_dir) -> List[InputExample]:
        """Get a collection of `InputExample`s for the unlabeled set."""
        pass

    @abstractmethod
    def get_dev_examples_poison(self, data_dir) -> List[InputExample]:
        """Get a collection of `InputExample`s for the unlabeled set."""
        pass
...
class Sst2Processor(DataProcessor):
    ...
    # def get_train_examples(self, data_dir):
    #     return self._create_examples(os.path.join(data_dir, "train_poison3-4.tsv"), "train")
    #
    # def get_dev_examples(self, data_dir):
    #     return self._create_examples(os.path.join(data_dir, "dev.tsv"), "dev")
    #
    # def get_dev_examples_poison(self, data_dir):
    #     return self._create_examples(os.path.join(data_dir, "dev_poison2.tsv"), "dev_poison")
    #
    # def get_test_examples(self, data_dir):
    #     return self._create_examples(os.path.join(data_dir, "test.tsv"), "test")
    #
    # def get_test_examples_poison(self, data_dir):
    #     return self._create_examples(os.path.join(data_dir, "test_poison2.tsv"), "test_poison")
    def get_train_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, train_file), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, dev_file), "dev")

    def get_dev_examples_poison(self, data_dir):
        return self._create_examples(os.path.join(data_dir, dev_file), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, test_file), "test")
...
DEV32_SET = "dev32"
TEST_SET_POISON = "test_poison"
DEV_SET_POISON = "dev_poison"
...
def load_examples(task, data_dir: str, set_type: str, *_, num_examples: int = None,
    ...
    SET_TYPES = [TRAIN_SET, DEV_SET, TEST_SET, UNLABELED_SET, DEV32_SET, TEST_SET_POISON, DEV_SET_POISON]
    ...
    elif set_type == TEST_SET_POISON:
        examples = processor.get_test_examples_poison(data_dir)
    elif set_type == DEV_SET_POISON:
        examples = processor.get_dev_examples_poison(data_dir)
