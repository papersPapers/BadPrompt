...
import myconfig
early_stop_epochs = myconfig.early_stop_epochs
...
parser.add_argument("--train_examples", default=myconfig.sample_num, type=int,
                    help="The total number of train examples to use, where -1 equals all examples.")
parser.add_argument("--eval_examples", default=myconfig.sample_num, type=int,
                    help="The total number of test examples to use, where -1 equals all examples.")
parser.add_argument("--dev_examples", default=myconfig.sample_num, type=int,
...
parser.add_argument("--early_stop_epochs", default=early_stop_epochs, type=int,
...
parser.add_argument("--eval_every_step", default=myconfig.eval_every_step, type=int, help="")
...
def process_args(args):
    ...
    args.device = myconfig.cuda if torch.cuda.is_available() and not args.no_cuda else "cpu"
